...
class SecondScreen(Screen):
    ...
    def __init__(self, **kwargs):
        ...
        self.btn_opcion1 = ToggleButton(text='Propiedad de 3ero dañada', size_hint=(1, None), height=50,font_size=25)
        self.btn_opcion2 = ToggleButton(text='Daños a personas', size_hint=(1, None), height=50,font_size=25)
        self.btn_opcion3 = ToggleButton(text='Volcadura de transporte', size_hint=(1, None), height=50,font_size=25)
        self.btn_opcion4 = ToggleButton(text='Lesiones de transportista', size_hint=(1, None), height=50,font_size=25)
        ...
        self.lbl_mensaje_enviado = Label(text="Mensaje enviado", font_size=30, size_hint=(1, None), height=20, opacity=0, color=(1, 1, 1, 1), valign='middle')
